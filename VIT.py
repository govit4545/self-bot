...
☬[SP,Speed]
☬[Group id]
☬[Gcall,ลบรัน] เชลบอท ลบรัน
☬[K1-K6 Gcall,ลบรัน] kicker ลบรัน
☬[Login,login,ขอลิ้ง] ขอลิ้งลบรัน
☬[Point] ตั้งค่าดูคนอ่าน
☬[Read] ดูคนที่แอบอ่าน
☬[Tagall] แท็กเพื่อน ทั้งหมด
☬[All] kicker เข้าทั้งหมด
☬[K1-K6] เรียก kicker เข้าทีล่ะตัว
☬[K1-K6 bye] สั่ง kicker ออกทีล่ะตัว
☬[album 「id」]
☬[Hapus album 「id」
☬[Contact on] 
☬[Contact off] 
...
☬ชุด command in Group☬ ̶̲̅ʀ̶̲̅ᴏ̶̲̅ᴜ̶̲̅ᴘ̶̲̅
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""☬ധู้さန້ণق↔ധഖาໄฟ☬:
 👉 http://line.me/ti/p/9r-uE5EU09
""",
    "lang":"JP",
    "comment":"Thanks For Add Me",
    "commentOn":False,
    "comment":"Auto Like ☬Ŧ€ΆM฿❂Ŧ↔Pђãỳãƒir€☬",
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
    "clock":False,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u6c8aab6ee167a596be2cf045ee2f90df":
                    if "join:" in msg.text:
...
#----------------------------------------------------------------------
            if op.type == 15:
                if op.param2 in bot1:
                    return
                cl.sendText(op.param1,"หว่า ไปซะละ  " + cl.getContact(op.param2).displayName + "  ลาก่อน\n～(^з^)-♡")
...
#-----------------------------------------------------------------------
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n Powered By:☬ധู้さန້ণق↔ധഖาໄฟ☬"% (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#-----------------------------------------------------------------------------------
            ...
            elif msg.text in ["K1 Gift","K1 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '2'}
            ...
            elif msg.text in ["K2 Gift","K2 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '3'}
            ...
            elif msg.text in ["K3 Gift","K3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '4'}
            ...
            elif msg.text in ["K4 Gift","k4 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '5'}
            ...
            elif msg.text in ["K5 Gift","K5 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                     'PRDTYPE': 'THEME',
                                     'MSGTPL': '6'}
            ...
            elif msg.text in ["K6 Gift","K6 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                     'PRDTYPE': 'THEME',
                                     'MSGTPL': '5'}
...
#-----------------------------------------------------------
            elif msg.text in ["K1 Gcall","K1 ลบรัน"]:
...
#------------------------------------------------------
            elif msg.text in ["K2 Gcall","K2 ลบรัน"]:
...
#-----------------------------------------------------------
            elif msg.text in ["K3 Gcall","K3 ลบรัน1"]:
                      gid = ki3.getGroupIdsInvited()
                      for i in gid:
                         ki3.rejectGroupInvitation(i)
                      if wait["lang"] == "JP":
                         ki3.sendText(msg.to,"ปฏิเสทค้างเชิญเรียบร้อย")
                      else:
                         ki3.sendText(msg.to,"key is wrong")
#------------------------------------------------------------
            elif msg.text in ["K4 Gcall","K4 ลบรัน"]:
                      gid = ki4.getGroupIdsInvited()
                      for i in gid:
                         ki4.rejectGroupInvitation(i)
                      if wait["lang"] == "JP":
                         ki4.sendText(msg.to,"ปฏิเสทค้างเชิญเรียบร้อย")
                      else:
                         ki4.sendText(msg.to,"key is wrong")
#------------------------------------------------------------
            elif msg.text in ["K5 Gcall","K5 ลบรัน"]:
                      gid = ki5.getGroupIdsInvited()
                      for i in gid:
                         ki5.rejectGroupInvitation(i)
                      if wait["lang"] == "JP":
                         ki5.sendText(msg.to,"ปฏิเสทค้างเชิญเรียบร้อย")
                      else:
                         ki5.sendText(msg.to,"key is wrong")
#------------------------------------------------------------------
            elif msg.text in ["K6 Gcall","K6 ลบรัน"]:
...
#----------------------------------------------------------------------
            elif msg.text in ["Login","login","ขอลิ้ง"]:
                    if LINEVITLogged == False:
                        ki6.login(qr=True)
                        ki6.loginResult()
                        user2 = ki6.getProfile().mid
                        LINEVITLogged = True
                        cl.sendText(msg.to,"ล็อคอินสำเร็จ  พร้อมใช้งานแล้ว")
                    else:
                        cl.sendText(msg.to,"คุณ ได้ทำการล็อคอินไปแล้ว")
            elif msg.text.lower() == ".":
                    gs = []
                    try:
                    ...
                    if LINEVITLogged == True:
                        try:
                            ki6.sendText(user1,tlist)
                        except:
                            ki6.new_post(tlist)
                    else:
                        cl.sendText(msg.to,"คุณ ยังไม่ได้ล็อคอิน")
                ...
                if wait["autoCancel"]["on"] == True:md+="👉􀜁􀇔Auto cancel:" + str(wait["autoCancel"]["members"]) + "􀜁􀄯􏿿\n"
                ...
                else:md+="👉􀇔Auto add:off 􀜁��􏿿\n"
                if wait["commentOn"] == True: md+="👉􀜁􀇔Auto komentar:on 􀜁􀄯􏿿\n"
                else:md+="👉􀇔􏿿Auto komentar:off 􀜁􀄰􏿿\n"
                if wait["protect"] == True: md+="👉 Protect:on 🔓\n"
                else:md+="👉 Protect:off 🔒\n"
                if wait["linkprotect"] == True: md+="👉􀇔􏿿Link Protect:on 🔓\n"
                else:md+="👉􀜁􀇔Link Protect:off🔒\n"
                if wait["inviteprotect"] == True: md+="👉􀜁􀇔Invitation Protect:on🔓\n"
                else:md+="👉􀜁􀇔Invitation Protect:off🔒\n"
